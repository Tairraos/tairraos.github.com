...
let setup = {
    ...
    proCols: ["项目编号", "项目名称", "报告编制人", "地区", "费用", "检测时间", "报告完成时间", "归档完成时间"], //从业务报告提取字段
    proWidths: [125, 400, 60, 60, 60, 80, 80, 80], //导出账务帐的列宽
    proPreview: ["项目编号", "项目名称", "报告编制人", "地区", "费用", "检测时间", "报告完成时间", "归档完成时间"],

    ledCols: ["报告编号", "项目名称", "金额", "评审费", "交接人", "业务员", "交接日期", "类型", "报告份数", "发票", "去向", "给企业日期", "备注"], //从从台账报告提取字段
     ...
     * 评审费 = ledData.评审费
     */
    comCols: ["项目编号", "项目名称", "金额", "评审费"], //对比结果表头
