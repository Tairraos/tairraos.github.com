...
let setup = {
    finData: [], //财务账数据(文件名含"多谱到账"或财务账四字)
    ...
    finCols: ["形式", "到款日期", "对方户名", "到款金额", "备注"], //从财务账提取字段
    finWidths: [60, 80, 400, 80, 400], //导出账务帐的列宽
    finPreview: ["形式", "到款日期", "对方户名", "到款金额", "备注"], //屏幕上回显的列
    ...
    ledWidths: [].concat(
        [60, 80, 50, 60, 100, 80, 100], //导出台账的列宽
    ...
    currencyList: ["月份", "合同额", "合作费", "其他费用", "评审费", "应收款", "净额", "开票逾期天数", "到款金额"], //提取后，转成数值型的字段
...
setup.ledComCols = [...setup.ledCols, "匹配状态"]; //比对账台账表头
setup.ledComWidths = [...setup.ledWidths, 60]; //宽度
