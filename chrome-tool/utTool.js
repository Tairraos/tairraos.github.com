/**
 * UT统计工具
 * javascript:(function(){var tool='utTool',css='utTool',p=window.pageTools;if(p&&p[tool]){p[tool].run();return;}var d=document,s=d.createElement('script');s.setAttribute('src','//localhost/tools/loader.js?tool='+tool+'&css='+css);d.body.appendChild(s);}());
 */
(function ($) {
    'use strict';
    ...
    function genReport(filePool) {
        ...
        conf.title = document.title = 'Build ' + $('#targetVer').val() + ' vs Build ' + $('#sourceVer').val();
